"""
Django settings for testapp_39785 project.
...
ROOT_URLCONF = 'testapp_39785.urls'
...
WSGI_APPLICATION = 'testapp_39785.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_39785 API",
    "DESCRIPTION": "API documentation for testapp_39785 App",
    "VERSION": "v1",
}
